...
sh any content of this project.
...
In the following examples, the main.c files are shown as examples. You can use them to test your functions, but you don’t have to push them to your repo (if you do we won0x17. C - Doubly linked lists
C
Algorithm
Data structure
 By: Julien Barbier
...
You are not allowed to ’t take them into account). We will use our own main.c files at compilation. Our main.c files might be different from the one shown in the examples
...
julien@ubuntu:~/0x17. Doubly linked lists$ valgrind  if it failed
...
GitHub repository: alx-l username key
The crackme will segfault if you do not enter the correct key for the user
Usage for your keygen: ./ke./e 
...
==4197==   total heap usage: 9 allocs, 9 frees, 1,216 bytes allocate7. Doubly linked lists$ gcc -Wall -pedantic -Werror -Wextra -std=gnu89 1-main.c 1-dlistint_len.c -o b
...
Return: the address of the new element, or NULLygen5 username
